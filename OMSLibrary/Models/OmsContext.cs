...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=OMS;Integrated Security=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Basket>(entity =>
        {
            entity.HasKey(e => e.IdBasket).HasName("PK__Basket__7ADD396B96DE3D8B");
        ...
        {
            entity.HasKey(e => e.IdBasketItem).HasName("PK__BasketIt__2B9ACCF566AE4250");
        ...
        {
            entity.HasKey(e => e.IdProduct).HasName("PK__Product__5EEC79D15677E80E");
        ...
        {
            entity.HasKey(e => e.IdShopper).HasName("PK__Shopper__14739D5221011203");
